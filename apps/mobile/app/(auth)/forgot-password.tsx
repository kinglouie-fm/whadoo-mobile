...
export default function ForgotPasswordScreen() {
    ...
    const sendLink = async () => {
        ...
        try {
            ...
            if (code === "auth/invalid-email") {
                ...
                Alert.alert("Try again later", "Too many attempts. Please wait a bit and try again.");
            } else {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: theme.colors.bg, padding: 24, justifyContent: "center" }}>
            <Text style={{ fontFamily: theme.fonts.bold, color: theme.colors.text, fontSize: 24, textAlign: "center" }}>
                Confirm your email
            </Text>
            ...
            <Text style={{ fontFamily: theme.fonts.medium, color: theme.colors.text, marginBottom: 6 }}>
                Enter your email
            </Text>
            ...
            <PrimaryButton title={busy ? "..." : "Send reset Link"} onPress={sendLink} disabled={busy} />

            <Pressable onPress={() => router.back()} style={{ marginTop: 18, alignItems: "center" }}>
                <Text style={{ fontFamily: theme.fonts.medium, color: theme.colors.muted }}>Back</Text>
            </Pressable>
        </View>
    );
}

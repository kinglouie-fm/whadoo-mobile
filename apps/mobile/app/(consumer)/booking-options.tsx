...
import { PriceSummaryCard } from "@/src/components/Card";
...
export default function BookingOptionsScreen() {
  ...
  const displayData =
    currentGroup ||
    (currentActivity ? { activities: [currentActivity] } : null);
  ...
  return (
    <SafeAreaView style={ui.container} edges={["top"]}>
      ...
      <ScreenContainer
        loading={loading}
        error={
          !displayData || !selectedActivity ? "Activity not found" : undefined
        }
      >
            ...
            <View style={ui.section}>
              ...
              {selectedPackage &&
                (minParticipants > 1 || maxParticipants < 20) && (
                  <Text
                    style={[typography.captionMuted, styles.participantHint]}
                  >
              ...
              <View style={styles.participantsContainer}>
                <TouchableOpacity
                  style={[
                    ...
                    participantsCount <= minParticipants &&
                      styles.participantButtonDisabled,
                  ]}
                  onPress={() =>
                    setParticipantsCount(
                      Math.max(minParticipants, participantsCount - 1),
                    )
                  }
                ...
                >
                  <Text
                    style={[
                      ...
                      participantsCount <= minParticipants &&
                        styles.participantButtonTextDisabled,
                    ]}
                  >
                    −
                  </Text>
                ...
                <TouchableOpacity
                  ...
                  onPress={() =>
                    setParticipantsCount(
                      Math.min(maxParticipants, participantsCount + 1),
                    )
                  }
                  ...
                  <PriceSummaryCard
                    ...
                    total={(
                      (hasPackages && packages[selectedPackageIndex]?.base_price
                        ...
                        : Number(selectedActivity.priceFrom)) *
                      participantsCount
                    ).toFixed(2)}
                    currency="EUR"
                    style={styles.priceCardMargin}
